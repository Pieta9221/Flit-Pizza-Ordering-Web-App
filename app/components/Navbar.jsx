  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black">
      <div className="p-8 rounded-md w-4/5 h-3/5 bg-transparent flex flex-col items-center relative">
        ...
        />
        <div className="absolute top-[17%] md:top-[15%] right-10 cursor-pointer text-white">
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white shadow-md sticky top-0 h-150 z-50">
      ...
      <div className="absolute hidden md:block top-[-30px] md:top-[-10px] left-[20%]">
          <Image src="/header-img.png" alt="Logo" width={200} height={70} />
      </div>
      <div className="absolute md:hidden top-[-30px] md:top-[-10px] left-[15%]">
          <Image src="/header-img.png" alt="Logo" width={150} height={50} />
      </div>
